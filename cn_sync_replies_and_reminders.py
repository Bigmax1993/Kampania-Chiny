...
Domyślnie TRYB PODGLĄDU (bez wysyłki). Aby wysłać maile:
  python cn_sync_replies_and_reminders.py --send

Przykłady:
  python cn_sync_replies_and_reminders.py
  python cn_sync_replies_and_reminders.py --send
  python cn_sync_replies_and_reminders.py --send --min-days 3 --max-send 50
"""
...
def pl_preset() -> dict:
    paths = campaign_output_paths(REPO_ROOT, "cn_materialy")
    return {
...
def setup_logging() -> logging.Logger:
    return setup_module_logging("cn_sync_replies_and_reminders")
