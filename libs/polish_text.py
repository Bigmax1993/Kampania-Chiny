# -*- coding: utf-8 -*-
"""
UTF-8 i chińskie znaki (ąćęłńóśźż) — konfiguracja środowiska, naprawa kodowania, logi, subprocess.
"""
...
def fix_polish_mojibake(text: str) -> str:
    """Naprawia typowe błędy kodowania (np. WojewÃ³dztwo → Prowincja)."""
    if not text:
        return ""
    s = str(text)
...
def sanitize_special_text(value: Any) -> str:
    """Czyści tekst z kontrolnych znaków; zachowuje chińskie litery."""
