...
$script:DefaultRunConfig = "run_config\cn_materialy.json"
...
function Set-KanbudGoogleDriveDataDir {
    ...
    $names = @("CN Materialy Budowlane Wyniki", "Kanbud CN Materialy Wyniki", "cn_materialy_wyniki")
