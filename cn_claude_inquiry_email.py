# -*- coding: utf-8 -*-
"""Claude: spersonalizowane zapytania mailowe PL (chiński) per firma."""
...
from cn_materialy_inquiry_email_zh import ensure_inquiry_contact_in_body
...
def claude_generate_inquiry_email_zh(
    company_name: str,
    logger,
    cache: dict | None,
    *,
    ...
    """
    Pełna personalizacja maila B2B po chińsku. Zwraca (subject, body) lub None.
