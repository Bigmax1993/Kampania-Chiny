...
_DRIVE_FOLDER_NAMES_CN = (
    "CN Materialy Budowlane Wyniki",
    "Kanbud CN Materialy Wyniki",
    "cn_materialy_wyniki",
)
...
def resolve_data_root(campaign_dir: Path, *, campaign: str = "cn") -> Path:
    """
    Katalog danych kampanii: Wyniki/, wyslane/.
    campaign: gu | ua | pl | cn
    """
    if campaign == "ua":
        folder_names = _DRIVE_FOLDER_NAMES_UA
    elif campaign == "cn":
        folder_names = _DRIVE_FOLDER_NAMES_CN
    else:
