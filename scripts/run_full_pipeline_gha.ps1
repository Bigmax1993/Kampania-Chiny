...
if (-not $SkipBackfill) {
    Invoke-GhaWorkflow "CN niedziela backfill"
}

Invoke-GhaWorkflow "Sync wyniki Google Drive CN" @{ artifact_name = "cn-materialy-wyniki-thu" }
Invoke-GhaWorkflow "CN poniedzialek prep"
